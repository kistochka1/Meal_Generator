...
# Хранилище блюд (в реальном приложении лучше использовать базу данных)
# Но для простоты используем список в памяти сервера
dishes = ['Борщ', 'Пельмени', 'Цезарь', 'Паста Карбонара']  # начальные примеры

# HTML код прямо внутри Python
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="ru">
<head>
...
<script>
    // Функция для загрузки списка блюд с сервера
